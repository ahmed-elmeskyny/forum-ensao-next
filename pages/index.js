  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="forum Ensao Entreprises 10 eme edition page d'acceuil"
        />
        ...
        <link rel="preconnect" href="https://fonts.gstatic.com" />
        <link
          href={`https://fonts.googleapis.com/css2?family=Andika+New+Basic&family=Josefin+Sans:ital,wght@1,300&display=swap`}
          rel="stylesheet"
        />
        <link rel="preconnect" href="https://fonts.gstatic.com" />
        <link
