        ...
        <div className={styles.footerContainer}>
            <div className={styles.footerHero}>
                <div className={styles.logoSection}>
                    <Image alt="logo" src="/logoForum.png" width="100px" height="100px"/>
            ...
            <div className={styles.infoContainer}>
                ...
                <div className={styles.contact}>
                    ...
                    <div className={styles.contactButton}>
                        ...
                        <Link  href="/contact"><a className={styles.link}> CONTACTEZ-NOUS !</a></Link>
                    </div>
                </div>
            </div>
        </div>
        <div className={styles.copyright}>
        <span> Copyright © 2020 | Forum Ensao Entreprises || By <span style={{color : "#11b67a" , textDecoration:"underline"}}><Link href="http://ahmed-elmeskyny.herokuapp.com/"><a>Ahmed El Meskyny</a></Link></span></span>
